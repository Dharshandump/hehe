...
export function About() {
  ...
  <p className='text-pretty'>
    I'm always exploring new ideas — whether it's experimenting with <span className="gradient-text font-medium">AI tools</span>, contributing to projects, or helping a vision come to life. <span className="gradient-text font-semibold">Let's build something impactful together.</span>
  </p>
      <ViewResumeButton />
    </section>
  );
